# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2020-05-20 18:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('spi', models.FileField(default='spi_spreadsheet/1991-2018_San_Gemini_SPI12_noeff_prec.xls', upload_to='spi_spreadsheet', verbose_name='SPI excel file')),
                ('spi_1mesi', models.FloatField(blank=True, default=0, null=True)),
                ('spi_3mesi', models.FloatField(blank=True, default=0, null=True)),
                ('spi_6mesi', models.FloatField(blank=True, default=0, null=True)),
                ('data_spi_cruscotti', models.DateField(default=datetime.date.today)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='iframe_stazioni',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iframeURL', models.URLField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='quote_stazioni',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geom', django.contrib.gis.db.models.fields.MultiPointField(srid=32633)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.AddField(
            ...
            name='stazioni',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='income.stazioni_retevista'),
        ),
        migrations.AddField(
            model_name='iframe_stazioni',
            name='stazioni',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='income.stazioni_retevista'),
        ),
        migrations.AddField(
            model_name='dati_spi',
            name='stazione_pluviometrica',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='income.stazioni_umbria'),
        ),
        migrations.AddField(
