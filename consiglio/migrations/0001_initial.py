    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appezzamento', models.ForeignKey(help_text='Appezzamento aziandale al quale associare il raster', on_delete=django.db.models.deletion.CASCADE, to='consiglio.appezzamentoCampo', verbose_name='Appezzamento aziendale')),
            ],
            options={
