    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dash_aziende.campi', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('A', models.FloatField(default=0.0, help_text='colonna M', verbose_name='capacit\xe0 idrica massima')),
                ('Amin_irr', models.FloatField(blank=True, default=40.0, null=True, verbose_name='Amin Irr')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipologia', models.CharField(blank=True, choices=[('OM', 'Sostanza organica'), ('classi', 'Zonizzazione')], default=('OM', 'Sostanza organica'), max_length=250, null=True, verbose_name='Tipologia del raster')),
