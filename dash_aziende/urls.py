...
from .views import dashboard_fields,form_campi,add_profile,CampiGeoJson,form_analisi,dashboard_analisi,AnalisiGeoJson,CampoUpdateView,AnalisiUpdateView,CampoDeleteView,AnalisiDeleteView,dashboard_main
